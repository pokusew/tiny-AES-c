...
// E.g. with GCC by using the -D flag: gcc -c aes.c -DTINYAES_ENABLE_CBC=0 -DTINYAES_ENABLE_CTR=1 -DTINYAES_ENABLE_ECB=1
...
#if defined(TINYAES_ENABLE_AES256)
	printf("\nTesting TINYAES_ENABLE_AES256\n\n");
#elif defined(TINYAES_ENABLE_AES192)
	printf("\nTesting TINYAES_ENABLE_AES192\n\n");
#elif defined(TINYAES_ENABLE_AES128)
	printf("\nTesting TINYAES_ENABLE_AES128\n\n");
#else
	printf("You need to specify a symbol between TINYAES_ENABLE_AES128, TINYAES_ENABLE_AES192 or TINYAES_ENABLE_AES256. Exiting");
	return 0;
#endif
